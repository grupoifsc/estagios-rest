...
@Validated
public class OrgPublicProfileBasicView extends OrgBasicView implements OrgPublicProfileProjection {
    ...
    @NotNull
    @Valid
    private ContactView mainContact;

    @JsonProperty(value = "endereco", required = true)
    private AddressView mainAddress;
    ...
    public void setMainContact(@NotNull @Valid ContactView mainContact) {
    ...
    public void setMainAddress(AddressView mainAddress) {
